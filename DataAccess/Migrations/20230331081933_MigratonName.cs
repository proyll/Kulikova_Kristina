    ...
    public partial class MigratonName : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Filterr__D54EE9B42764DD68", x => x.category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Descript__0BD4214DF73CF4BB", x => new { x.product_id, x.customer_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__25ED2F57EC1899BB", x => new { x.product_id, x.cart_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Userss__B0FBA212394915FB",
                table: "Userss",
                column: "user_email",
                unique: true,
